...
export default function DemoPanel() {
  ...
  const { isDemoMode, demoStep, setDemoStep, toggleDemoMode } = useAppStore();
  ...
  return (
    <>
      <DemoSpotlight selector={currentStep.targetSelector} isActive={isDemoMode} />
          ...
          <div className="bg-[var(--bg-elevated)] border-2 border-[var(--primary)] rounded-3xl p-8 shadow-2xl backdrop-blur-xl relative overflow-hidden group">
            ...
            <div className="flex flex-col gap-4 mb-8">
              ...
              {currentStep.actionRequired && (
                <div className="bg-[var(--primary)]/10 p-3 rounded-lg border border-[var(--primary)]/20 animate-bounce mt-2">
                  <p className="text-[10px] font-mono font-bold text-[var(--primary-light)] uppercase tracking-widest text-center">
